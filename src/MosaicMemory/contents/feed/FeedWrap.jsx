...
import { setAdjustHeight, setTruncate, setTruncateText } from '../../utils/handler/handlerUtils'; 
...
const FeedWrap = () => {
    ...
    const adjustHeight = () => {
        setAdjustHeight(textarea, textareaBtn, 40, 130);
    };
    ...
    return (
        <div className="content_feed_wrap content_wrap">
